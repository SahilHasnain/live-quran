      ...
      >
        ...
        {loading ? (
          <View className="items-center justify-center py-24">
            ...
            <Text className="mt-4 text-neutral-400">Loading downloads...</Text>
          </View>
        ) : filteredDownloads.length === 0 ? (
          <View className="rounded-[28px] border border-white/10 bg-[#0a140e] p-12">
            <MaterialIcons name="download-done" size={52} color="#737373" />
              ...
              return (
                ...
                >
                  <View className="flex-row">
                    <TouchableOpacity activeOpacity={0.85} onPress={() => handlePlay(item)}>
                    ...
                    <View className="flex-1 justify-between p-6">
                      ...
                      <View className="flex-row items-center justify-between">
                        ...
                        <View className="flex-row items-center gap-3">
                          ...
                          >
                            <MaterialIcons name="delete-outline" size={18} color="#d4d4d4" />
                          </TouchableOpacity>
                          <MaterialIcons
