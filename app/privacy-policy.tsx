            ...
            <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                    <section>
                        ...
                        <p style={{
                            ...
                            Welcome to Live Quran. We respect your privacy and are committed to
                    ...
                    <section>
                        ...
                        <p style={{
                            ...
                            Live Quran is designed with privacy in mind. We collect minimal
                            information:
                        </p>
                        <ul style={{
                            marginLeft: "24px",
                            ...
                            <li>Audio playback history (stored locally on your device)</li>
                            <li>Downloaded audio files (stored locally on your device)</li>
                    ...
                    <section>
                        ...
                        <ul style={{
                            ...
                            <li>Provide offline listening through downloaded content</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p style={{
                            ...
                            downloaded audio files, are stored locally on your device. We do not
                    ...
                    <section>
                        ...
                        <ul style={{
                            ...
                            <li>Audio streaming services for live radio</li>
                            <li>Cloud storage for audio content delivery</li>
                        </ul>
                    </section>
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        © {new Date().getFullYear()} Live Quran. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
